...
import { View, StyleSheet, ImageBackground, ScrollView, Pressable, 
  Platform, Text, Modal, Button, useWindowDimensions, Dimensions } from "react-native";
...
// sets state for checkout + showcheckout
  ...
  return (
    ...
    <ImageBackground
      source={require("../assets/images/deepsea.png")}
      resizeMode="cover"
...
const styles = StyleSheet.create({
  ...
  results: {
    ...
    textShadowRadius: 1, // Outline width
  },
});
